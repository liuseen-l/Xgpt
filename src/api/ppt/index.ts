...
import type { RequestComment, RequestCommentList, RequestCreatePPT, RequestDeleteUpload, RequestFolderDelete, RequestFolderRename, RequestMyUpload, RequestPPTCollect, RequestPPTCollectList, RequestPPTCreateFolder, RequestPPTDetail, RequestPPTFolders, RequestPPTList, RequestPPTOutline, RequestReply, RequestReplyList, RequestScore, RequestViewPPT, ResponseComment, ResponseCommentList, ResponseCreatePPT, ResponseDeleteUpload, ResponseMyUpload, ResponsePPTClassify, ResponsePPTCollect, ResponsePPTCollectList, ResponsePPTDetail, ResponsePPTFolders, ResponsePPTList, ResponsePPTOutline, ResponsePPTTheme, ResponseReply, ResponseReplyList } from './types'
 ...
 * @returns
 */
export async function fetchScors(params: RequestScore) {
  return request.post(API_URL.PPT_SCORE, params)
}

export async function fetchPPTDetail(params: RequestPPTDetail) {
  const res = await request.get<ResponsePPTDetail>(API_URL.PPT_DETAIL, {
    params,
  })
  return res.data?.data
}
